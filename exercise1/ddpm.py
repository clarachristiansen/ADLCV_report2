...
class Diffusion:
    ...
    def get_betas(self, schedule='linear'):
        ...
        #     alphas_bar_minus1 = torch.cumprod(self.alphas[:-1], dim=0)
        #     return 1 - self.alphas_bar/alphas_bar_minus1            
        else :
    ...
    def q_sample(self, x, t):
        ...
        noise = torch.normal(0, 1, size=x.shape,  device=x.device) # HINT: sample noise from a normal distribution. It should match the shape of x 
    ...
    def p_sample(self, model, x_t, t):
        ...
        noise = torch.normal(0, 1, size=x_t.shape,  device=x_t.device)
